 ...
 *
 */
public class PUTMovement extends APIOperations {
	String HttpURL;
	...
	public PUTMovement(String user, String password, String accountId , Handler handler, Map<String, String> headers,Map<String,String> params, Context ctx){
		super(ctx);
		this.method="PUT";
	...
	public Message run() {
		...
		String _url=getURL()+operation;
			...
			HttpResponse response= helper.performPut(CONTENT_TYPE, _url, user, pass, headers, this.params);
