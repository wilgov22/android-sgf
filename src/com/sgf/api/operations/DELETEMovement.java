 ...
 *
 */
public class DELETEMovement extends APIOperations {
	String HttpURL;
	...
	public DELETEMovement(String user, String password, String accountId , Handler handler, Map<String, String> headers,Map<String,String> params, Context ctx){
		super(ctx);
		this.method="DELETE";
	...
	public Message run() {
		...
		String _url=getURL()+operation;
			...
			HttpResponse response= helper.performDelete(_url, user, pass, null) ;
